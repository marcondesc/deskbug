...
public class SeverityController : Controller
{
    ...
    public SeverityController(AppDbContext db)
    {
        _db = db;
    }
    ...
    {
        var severity = _db.Severities.OrderBy(x => x.Grade).ToList();
        var viewModel = new ListSeverityViewModel { Severities = severity };
        ViewData["Title"] = "Severities";
